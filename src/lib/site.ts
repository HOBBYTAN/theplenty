...
export const spaceSections: SpaceSection[] = [
  {
    id: "convention",
    eyebrow: "SPACES",
    title: "PLENTY Convention Space",
    features: [
      {
        title: "Convention Hall A+B",
        subtitle: "메인 행사장",
        description: "6.5m의 천고와 13m 미디어월을 갖춘 세미나ㆍ컨퍼런스ㆍ기업행사 맞춤 공간",
